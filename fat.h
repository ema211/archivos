...
typedef enum {
	...
	FR_READ_ONLY_FILE,		// File is read-only and cannot be deleted
	FR_INCORRECT_CHECKSUM,
	FR_UNKNOWN_ERROR
} FRESULT;
...
FRESULT FAT_openDir(DIR* dir_p, const char* path){
	...
	// Must be initialized to 0 otherwise subsequent functions won't won't properly
